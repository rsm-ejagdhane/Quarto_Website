...
## The Problem & The Data {transition="slide" .slide-dense .slide-problem-data}

::: {.slide-body}
::: {.slide-intro}
VCs review thousands of startups across fragmented sources — partner time is limited. We built on a fully synthetic, privacy-safe dataset with the same structure as real VC exports.
:::
...
- Partner time is the scarcest resource — most deals never get a real look
...
::: {.column width="48%"}
![Simulated data volume across three sources](images/data_sources.png){.slide-img .slide-img-sm}
...
## Before AI {transition="fade" .slide-dense}
...
## Key Drivers {transition="zoom" #marketing-analytics .slide-dense}
...
## Score Breakdown {transition="fade" .slide-dense}
...
## Results {transition="slide" .slide-dense}
...
::: {.column width="50%"}
![Precision at top-K against CRM labels](images/precision_metrics.png){.slide-img .slide-img-results}
...
![Score distribution across all ranked companies](images/score_distribution.png){.slide-img .slide-img-results}
:::
:::
...
## Impact & The AI Arms Race {transition="fade" .slide-dense}
