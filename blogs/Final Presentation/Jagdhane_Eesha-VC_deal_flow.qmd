...
::: {.column width="50%"}
![Precision at top-K against CRM labels](images/precision_metrics.png){.slide-img .slide-img-dense}
...
![Score distribution across all ranked companies](images/score_distribution.png){.slide-img .slide-img-dense}
:::
:::
