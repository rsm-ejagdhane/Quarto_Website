...
## {data-background="linear-gradient(135deg, #070b16 0%, #0b1020 45%, #1e1b4b 100%)"}
...
::: {.fragment .fade-up .callout .callout-accent}
...
```{mermaid}
%%| theme: dark
%%| init: {'theme': 'dark', 'themeVariables': {'primaryColor': '#6366f1', 'primaryTextColor': '#e8eaf0', 'primaryBorderColor': '#4f46e5', 'lineColor': '#8b95a8', 'secondaryColor': '#121a2e', 'tertiaryColor': '#0b1020'}}
flowchart LR
    A[CRM + Harmonic + PitchBook] --> B[Dedupe & Merge]
    B --> C[6 Feature Scores]
    C --> D[0–100 Ranking]
    D --> E[AI Summaries]
    E --> F[Evaluate vs CRM Labels]
    F --> G[API + Deal Memos]
    style A fill:#1e1b4b,stroke:#6366f1
    style D fill:#14532d,stroke:#22c55e
    style G fill:#3b0764,stroke:#a78bfa
```
...
## The Data {transition="slide" .has-dark-gradient}
