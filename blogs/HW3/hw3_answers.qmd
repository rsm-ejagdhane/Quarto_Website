...
| **age_sq** | − | Concave age profile — combined with the linear term, the implied peak sits near $0.149 / (2 \cdot 0.003) \approx 25$ years, almost exactly the sample's average firm age. |
| **region dummies** | mixed | All four region coefficients are small and statistically indistinguishable from zero ($p \geq 0.28$). After controlling for age and customer status, regional differences in patent counts essentially disappear. |
