...
fig_anim, ax_anim = plt.subplots(figsize=(7.5, 4))
...
ax_anim.set_title("Searching for the MLE: candidate λ vs. log-likelihood")
...
plt.close(fig_b)
display(HTML(anim_b.to_jshtml(default_mode="once")))
