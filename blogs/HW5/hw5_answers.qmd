...
Numbers in a table are precise; charts make the *pattern* obvious — especially where bivariate correlations disagree with multivariate decompositions. The bar and scatter charts are interactive (**hover** for values; click legend items to toggle methods).
